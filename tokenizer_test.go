...
func TestTokenizer(t *testing.T) {
	...
	for testCase, expectedTokens := range map[string][]*jlang.Token{
		...
		"0": {
			{Type: jlang.LiteralIntegerTokenType, Value: "0", Start: jlang.Location{Line: 0, Column: 0}, End: jlang.Location{Line: 0, Column: 1}},
		},
		"1279": {
			{Type: jlang.LiteralIntegerTokenType, Value: "1279", Start: jlang.Location{Line: 0, Column: 0}, End: jlang.Location{Line: 0, Column: 4}},
		},
		"0 Hello World 1279": {
			{Type: jlang.LiteralIntegerTokenType, Value: "0", Start: jlang.Location{Line: 0, Column: 0}, End: jlang.Location{Line: 0, Column: 1}},
			...
			{Type: jlang.LiteralIntegerTokenType, Value: "1279", Start: jlang.Location{Line: 0, Column: 14}, End: jlang.Location{Line: 0, Column: 18}},
		},
		"0 > 1 & { test.value }::": {
			{Type: jlang.LiteralIntegerTokenType, Value: "0", Start: jlang.Location{Line: 0, Column: 0}, End: jlang.Location{Line: 0, Column: 1}},
			{Type: jlang.SymbolTokenType, Value: ">", Start: jlang.Location{Line: 0, Column: 2}, End: jlang.Location{Line: 0, Column: 3}},
			{Type: jlang.LiteralIntegerTokenType, Value: "1", Start: jlang.Location{Line: 0, Column: 4}, End: jlang.Location{Line: 0, Column: 5}},
		...
		"0 >= 1 & { test.value }::": {
			...
			{Type: jlang.LiteralIntegerTokenType, Value: "1", Start: jlang.Location{Line: 0, Column: 5}, End: jlang.Location{Line: 0, Column: 6}},
		...
		"a = {0, 1, 2, 43} // This is a comment": {
			...
			{Type: jlang.LiteralIntegerTokenType, Value: "0", Start: jlang.Location{Line: 0, Column: 5}, End: jlang.Location{Line: 0, Column: 6}},
			{Type: jlang.SymbolTokenType, Value: ",", Start: jlang.Location{Line: 0, Column: 6}, End: jlang.Location{Line: 0, Column: 7}},
			{Type: jlang.LiteralIntegerTokenType, Value: "1", Start: jlang.Location{Line: 0, Column: 8}, End: jlang.Location{Line: 0, Column: 9}},
			{Type: jlang.SymbolTokenType, Value: ",", Start: jlang.Location{Line: 0, Column: 9}, End: jlang.Location{Line: 0, Column: 10}},
			{Type: jlang.LiteralIntegerTokenType, Value: "2", Start: jlang.Location{Line: 0, Column: 11}, End: jlang.Location{Line: 0, Column: 12}},
			{Type: jlang.SymbolTokenType, Value: ",", Start: jlang.Location{Line: 0, Column: 12}, End: jlang.Location{Line: 0, Column: 13}},
			{Type: jlang.LiteralIntegerTokenType, Value: "43", Start: jlang.Location{Line: 0, Column: 14}, End: jlang.Location{Line: 0, Column: 16}},
		...
		"a = {0, 1, 2, 43} // This is a comment\nb = a // Another comment\n10": {
			...
			{Type: jlang.LiteralIntegerTokenType, Value: "10", Start: jlang.Location{Line: 2, Column: 0}, End: jlang.Location{Line: 2, Column: 2}},
		},
	} {
