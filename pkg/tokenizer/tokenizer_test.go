...
func TestTokenizer(t *testing.T) {
	...
	for testCase, expectedTokens := range map[string][]*tokenizer.Token{
		...
		`a = "this is a string!" b = "an escaped \" string"`: {
			{Type: tokenizer.IdentifierTokenType, Value: "a", Delimitation: sources.Delimitation{Start: sources.Location{Line: 0, Column: 0}, End: sources.Location{Line: 0, Column: 1}}},
			{Type: tokenizer.SymbolTokenType, Value: "=", Delimitation: sources.Delimitation{Start: sources.Location{Line: 0, Column: 2}, End: sources.Location{Line: 0, Column: 3}}},
			...
			{Type: tokenizer.IdentifierTokenType, Value: "b", Delimitation: sources.Delimitation{Start: sources.Location{Line: 0, Column: 24}, End: sources.Location{Line: 0, Column: 25}}},
			{Type: tokenizer.SymbolTokenType, Value: "=", Delimitation: sources.Delimitation{Start: sources.Location{Line: 0, Column: 26}, End: sources.Location{Line: 0, Column: 27}}},
			{Type: tokenizer.LiteralStringTokenType, Value: `"an escaped \" string"`, Delimitation: sources.Delimitation{Start: sources.Location{Line: 0, Column: 28}, End: sources.Location{Line: 0, Column: 50}}},
		},
	} {
